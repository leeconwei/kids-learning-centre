...
<section class="ftco-section">
	<div>
		...
		<form class="offset-4" action="php/enrol.php" id="enrollForm" method="post">
			<div class="form-group">
				<label>Programme Name</label>
				<input type="name" name="p_name" class="form-control" value="Holiday Programme" readonly>
			</div>
			...
			<div class="form-group">
				...
				<select class="custom-select custom-select-sm" name="selectedProgramme" id="selectedProgramme" onchange="getTotal()" required>
				  ...
				  <option value="dance">Contemporary dance and story making</option>
				  <option value="sea">Creatures of the Sea World</option>
				  <option value="lego">Lego and World Architecture</option>
				</select>
			</div>
	
			<div class="form-group">
				<label>Period of time</label>
				<input type="name" class="form-control" name="selectedPeriod" id="selectedPeriod" value="1 month" readonly>
			</div>
...
<script>
	...
	var programme_prices = new Array();
		programme_prices["alice"]=400;
		programme_prices["dance"]=400;
		programme_prices["sea"]=450;
		programme_prices["lego"]=450;
