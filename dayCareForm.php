...
<form class="offset-4" action="php/enrol.php" id="dayCareForm" method="post">
  <div class="form-group">
	<label>Programme Name</label>
    <input type="name" name="p_name" class="form-control" value="Day Care Programme" readonly>
	</div>
  ...
  <option value="Toddlers Centre (6 months - 3 years old)">Toddlers Centre (6 months - 3 years old)</option>
  <option value="Junior Centre (4 - 6 years old)">Junior Centre (4 - 6 years old)</option>
  <option value="Senior Centre (7 - 12 years old)">Senior Centre (7 - 12 years old)</option>
</select>
	</div>
  ...
  <option value="12 months">12 months (30% discount)</option>
    ...
    <input type="tel" name="c_id" pattern="[0-9]{6}-[0-9]{2}-[0-9]{4}" class="form-control" placeholder="xxxxxx-xx-xxxx" required>
	</div>
...
<script>
	...
	var programme_prices = new Array();
		programme_prices["Toddlers Centre (6 months - 3 years old)"]=500;
		programme_prices["Junior Centre (4 - 6 years old)"]=550;
		programme_prices["Senior Centre (7 - 12 years old)"]=600;
		
	function getProgrammePrice(){
		var programmePrice=0;
		var form=document.forms["dayCareForm"];
	...
	function getTotal(){
	 ...
	 function setTotal(){
		document.dayCareForm.total.value = getTotal();
		document.forms["dayCareForm"].submit();
	 }
