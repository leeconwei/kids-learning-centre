...
<section class="ftco-section">
	<div>
		...
		<form class="offset-4" id="enrollForm" name="enroll" method="POST" action="php/enrol.php">
			<div class="form-group">
				<label>Programme Name</label>
				<input type="name" name="p_name" class="form-control" value="Abacus Class" readonly>
			</div>
	
			<div class="form-group">
				<label>Programme Type</label>

				<input type="name" class="form-control" name="selectedProgramme" id="selectedProgramme" value="Brain Development Program" readonly>
			...
			<div class="form-group">
				...
				<select class="custom-select custom-select-sm" name="payment_type" required>
...
<script>
	...
	var programme_prices = new Array();
		programme_prices["Brain Development Program"]=180;
