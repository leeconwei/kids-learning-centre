...
<html>
<head>
<title>KidsPlanet - Payment</title>
	 <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Profile <i class="ion-ios-arrow-forward"></i></a></span> <span>Payment <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
...
<?php
include('php/dbh.php');
	$sql="SELECT SUM(total) FROM enrollment WHERE user='$id' AND status='unpaid';"; 
...
<form class="offset-4" action="php/outstanding.php" method="POST">

	<div class="form-group">
	<label for="educationlevel">Outstanding fees</label>
    <p>RM <?php echo$row['SUM(total)'];?></p>
	</div>
	
	<div class="form-group">
	<label for="educationlevel">Amount Paid</label>
    <p>RM <?php echo$row['SUM(total)'];?></p>
	</div>
	<div class="form-group">
	<label for="receipt">Upload your receipt here</label><div class="text-left">
