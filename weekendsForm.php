	...
	<div>
		...
		<form class="offset-4" id="enrollForm" action="php/enrol.php" method="post">
			...
			<div class="form-group">
				...
				<input type="name" name="p_name" class="form-control" value="Weekends Programme" readonly>
			</div>
			...
			<div class="form-group">
				...
				<select class="custom-select custom-select-sm" name="selectedProgramme" id="selectedProgramme" onchange="getTotal()" required>
				  ...
				  <option value="cook">Little Cooks: Summer Buggin’ (ages 5-7)</option>
				  <option value="think">Think Tank: Wings & Things (ages 7-10)</option>
				  <option value="living">Living Lab: Circle of Life (ages 6-9)</option>
				  <option value="chefs">Young Chefs – Yummy Peach Cobbler (ages 8-12)</option>
				</select>
			</div>
...
<script>
	...
	var programme_prices = new Array();
		programme_prices["cook"]=120;
		programme_prices["think"]=100;
		programme_prices["living"]=100;
		programme_prices["chefs"]=150;
