	...
	<div>
		...
		<form class="offset-4" id="enrollForm" action="php/enrol.php" method="post">
			<div class="form-group">
				...
				<input type="name" name="p_name" class="form-control" value="Art Class" readonly>
			</div>
			...
			<div class="form-group">
				...
				<select class="custom-select custom-select-sm" name="selectedProgramme" id="selectedProgramme" onchange="getTotal()" required>
				  ...
				  <option value="little">Little Da Vinci Creative Kids Art (age 3 and above)</option>
				  <option value="junior">Junior Da Vinci Creative Kids Art (age 5-11)</option>
				  <option value="intermediate">Intermediate Da Vinci Creative Kids Art (age 7-12)</option>
				</select>
			</div>
...
<script>
	...
	var programme_prices = new Array();
		programme_prices["little"]=150;
		programme_prices["junior"]=170;
		programme_prices["intermediate"]=200;
